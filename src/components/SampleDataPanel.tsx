    ...
    <div className="rounded-2xl border border-dashed border-amber-400 bg-amber-50 p-4">
      <div className="flex items-start gap-2">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-base font-semibold text-amber-950">예시 데이터</p>
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <button
              ...
              disabled={busy}
              onClick={seed}
              className="rounded-xl bg-amber-600 px-3.5 py-2.5 text-sm font-semibold text-white disabled:opacity-50"
            >
            ...
            {hasSample && (
              <button
                ...
                disabled={busy}
                onClick={remove}
                className="rounded-xl border border-amber-600 bg-white px-3.5 py-2.5 text-sm font-semibold text-amber-950 disabled:opacity-50"
              >
                예시 데이터 삭제
              </button>
            )}
